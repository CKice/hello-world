class MD5 {
	...
	public static hex_md5(s) { return this.binl2hex(this.core_md5(this.str2binl(s), s.length * this.chrsz)); }
	public static b64_md5(s) { return this.binl2b64(this.core_md5(this.str2binl(s), s.length * this.chrsz)); }
	public static str_md5(s) { return this.binl2str(this.core_md5(this.str2binl(s), s.length * this.chrsz)); }
	public static hex_hmac_md5(key, data) { return this.binl2hex(this.core_hmac_md5(key, data)); }
	public static b64_hmac_md5(key, data) { return this.binl2b64(this.core_hmac_md5(key, data)); }
	public static str_hmac_md5(key, data) { return this.binl2str(this.core_hmac_md5(key, data)); }
